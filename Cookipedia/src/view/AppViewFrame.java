...
public class AppViewFrame extends javax.swing.JFrame {
    ...
    private final Color viewNormalBg = Color.BLACK; 
    ...
    */
    private javax.swing.JPanel createRecipeCard(RecipeData r) {
        ...
        card.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(230, 230, 230), 1, true));
        ...
        if (imgPath != null) {
            ...
            if (imgUrl != null) {
                ...
                java.awt.Image scaled = icon.getImage().getScaledInstance(218, 150, java.awt.Image.SCALE_SMOOTH);                 
        ...
        String infoText = String.format("%s • %s • %d min • %.1f ★",r.getCuisine() != null ? r.getCuisine() : "Cuisine",
                r.getDifficulty() != null ? r.getDifficulty() : "Difficulty",r.getPrepTime(),r.getRating());
    ...
    private void populateViewPanel(RecipeData recipe) {
        ...
        if (recipe.getImagePath() != null && !recipe.getImagePath().isBlank()) {  
            try {
                ...
                if (url != null) {javax.swing.ImageIcon icon = new javax.swing.ImageIcon(url);
    ...
    */
    private void handleRecipeCooked(RecipeData recipe) {
        try {
            ...
            javax.swing.JOptionPane.showMessageDialog(this,"Marked as cooked!","Success",javax.swing.JOptionPane.INFORMATION_MESSAGE);
        } catch (Exception ex) {
            ex.printStackTrace();
            javax.swing.JOptionPane.showMessageDialog(this,"Could not mark as cooked: " + ex.getMessage(),"Error",javax.swing.JOptionPane.ERROR_MESSAGE);
        }
    }
    ...
    */
    private void loadAdminRecipesTable() {
        javax.swing.table.DefaultTableModel dtm =(javax.swing.table.DefaultTableModel) adminRecipeTable.getModel();
        dtm.setRowCount(0);
    ...
    */
    private void loadDeletedRequestsTable() {
        ...
        javax.swing.table.DefaultTableModel dtm = (javax.swing.table.DefaultTableModel) deletedRequestsTable.getModel();
        dtm.setRowCount(0);
    ...
    */
    ...
    private void initComponents() {
        ...
        loginPanelLayout.setHorizontalGroup(
            ...
            .addGroup(loginPanelLayout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jPanel8, javax.swing.GroupLayout.DEFAULT_SIZE, 732, Short.MAX_VALUE))
        );
        ...
        logoutButtonAdmin.setBounds(1090, 10, 100, 42);
        ...
        jLabel16.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/bannerRequestPage.png"))); // NOI18N
        ...
        manageRequestsPanelLayout.setHorizontalGroup(
            ...
            .addGroup(manageRequestsPanelLayout.createSequentialGroup()
                .addGroup(manageRequestsPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, manageRequestsPanelLayout.createSequentialGroup()
                        .addGap(49, 49, 49)
                        .addGroup(manageRequestsPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addGroup(manageRequestsPanelLayout.createSequentialGroup()
        ...
        adminPanelLayout.setHorizontalGroup(
            ...
            .addComponent(baseAdminPAnel, javax.swing.GroupLayout.PREFERRED_SIZE, 1233, Short.MAX_VALUE)
        ...
        browsePanelLayout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, browsePanelLayout.createSequentialGroup()
                ...
                .addGroup(browsePanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(browseScrollPane, javax.swing.GroupLayout.PREFERRED_SIZE, 1124, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        browsePanelLayout.setVerticalGroup(
            ...
            .addGroup(browsePanelLayout.createSequentialGroup()
                ...
                .addComponent(jLabel6)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(browseScrollPane, javax.swing.GroupLayout.PREFERRED_SIZE, 590, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        String result = controller.addRecipe(title, cuisine, difficulty,prepTime, rating, imagePath,ingredients, process
        );
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        try {
            ...
            boolean updated = controller.updateRecipe(recipeId, title, cuisine,difficulty, prepTime, rating, imagePath,ingredients, process);
